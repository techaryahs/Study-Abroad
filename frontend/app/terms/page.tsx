    ...
    <main className="min-h-screen bg-[#FDFBF7] py-20 px-6 md:px-20 font-sans text-[#3C2A21]">
      ...
      >
        ...
        <div className="content-block">
            Welcome to International Eduleader Council (also known as IEC)!
          <p>
            These terms and conditions outline the rules and regulations for the use of International Eduleader Council's Website, located at https://iec.aryahsworld.com/.
          </p>
          <p>
          ...
          <p>
            We employ the use of cookies. By accessing IEC, you agreed to use cookies in agreement with the IEC's Privacy Policy.
          </p>
          <p>
          ...
          <p>
            Unless otherwise stated, IEC and/or its licensors own the intellectual property rights for all material on IEC. All intellectual property rights are reserved. You may access this from IEC for your own personal use subjected to restrictions set in these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul>
            <li>Republish material from IEC</li>
            <li>Sell, rent or sub-license material from IEC</li>
            <li>Reproduce, duplicate or copy material from IEC</li>
            <li>Redistribute content from IEC</li>
          </ul>
          ...
          <p>
            Certain refund requests for services may be considered by IEC on a case-by-case basis and granted in sole discretion of IEC. These are offered where IEC is no longer able to offer you a service due to constraints solely on IEC's end.
          </p>
          <p>
            A change of mind or any change in circumstances not controlled by IEC would not entitle the user to a refund.
          </p>
          <p>
            Any funds added due to an incorrect purchase which was not intentional would be eligible for a refund to the IEC wallet only.
          </p>
          <p>
          ...
          <ul>
            ...
            <li>IEC agents do not hold any liability of explaining the results of the RMC algorithm.</li>
          </ul>
        </div>
      </motion.div>
    </main>

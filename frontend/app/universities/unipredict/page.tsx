                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="relative">
                                        <input 
                                            ...
                                            required
                                            maxLength={3}
                                            className="w-full bg-[#F8F6F1]/50 border-2 border-transparent border-b-[#D4A848]/20 focus:border-[#D4A848] transition-all px-4 py-4 pr-16 text-xs sm:text-sm font-bold outline-none placeholder:text-[#362B25]/30"
                                        />

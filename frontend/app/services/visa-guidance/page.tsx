...
const visaFeatures = [
  { title: "Document Protocol", desc: "Precision checklist for country-specific financial and academic documentation.", icon: <FileText size={24} /> },
  { title: "Mock Interview", desc: "High-stakes simulation rounds with proven question sets and body language coaching.", icon: <Star size={24} /> },
  { title: "Success Pipeline", desc: "Priority filing and clinical review of your visa application narrative.", icon: <Zap size={24} /> },
  { title: "Global Mobility", desc: "Support for USA (F1), Canada (SDS), UK (Student), Germany (APS), and more.", icon: <Globe size={24} /> }
];
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <span className="inline-block px-5 py-2 rounded-full border border-[rgba(197,160,89,0.3)] text-[#C5A059] font-bold text-[11px] tracking-[0.2em] uppercase w-fit">
                Success Protocol Node
              </span>
            </div>
            <h1 className="fd text-3xl md:text-7xl font-bold leading-[0.95] text-[#3C2A21] break-words">
               PREMIUM <br /> <span className="gold-shimmer lowercase">Visa Guidance</span>
            </h1>
            <p className="text-[#6B5E51] text-lg md:text-xl font-medium leading-relaxed italic max-w-xl">
              "We maintain a near-perfect success rate by architecting your visa application with clinical precision."
            </p>
          </motion.div>
          ...
          <div className="lg:col-span-3 space-y-20 text-[#6B5E51]">
            <div className="space-y-8">
              <div className="space-y-4">
                <span className="text-[#C5A059] text-[11px] font-bold tracking-[0.3em] uppercase">The Success Strategy</span>
                <h2 className="fd text-4xl md:text-5xl font-bold leading-tight text-[#3C2A21]">Clinical <br /> <span className="gold-shimmer">Visa Orchestration</span></h2>
              </div>

              <div className="space-y-6 font-medium leading-relaxed max-w-2xl text-lg">
                <p>
                  Visa rejections often stem from incoherent financial documentation or lack of clarity during the interview. Our Visa Guidance node is designed to eliminate these risks through clinical preparation.
                </p>
                <p>
                  We provide a high-end simulation environment for your mock interviews and a meticulous review of your entire application narrative.
                </p>
              </div>
            </div>

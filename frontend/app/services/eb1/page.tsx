...
export default function EB1Page() {
   ...
   return (
      <main className="min-h-screen bg-[#F8F6F1] text-[#362B25] font-base selection:bg-[#D4A848]/20 relative overflow-hidden">
         ...
         {/* ── HERO COMPOSITION ──
             Two columns, shared top alignment:
             LEFT  — narrative + discussion
             RIGHT — hero image + membership access card (anchored as one stack)
         */}
         <section className="relative z-10 border-b border-[#D4A848]/10 px-6 pb-12 pt-8 md:px-20">
            <div className="mx-auto max-w-screen-2xl">
               ...
               >
                  ...
                  <div className="space-y-6 lg:col-span-7">
                     <motion.div variants={itemVariants} className="space-y-4">
                        <div className="space-y-2">
                           <span className="inline-block rounded-full border border-[#D4A848]/20 bg-[#FFFFFF] px-3 py-1 text-[11px] font-black uppercase tracking-[0.5em] text-[#D4A848] shadow-sm sm:text-[13px]">
                           ...
                           <h1 className="text-2xl font-black uppercase italic leading-[1.1] tracking-tight text-[#362B25] md:text-5xl">
                              ...
                              <span className="mt-1 block text-[#D4A848]">EB-1 VISA NODE</span>
                           </h1>
                        </div>
                        ...
                        <p className="hidden max-w-xl border-l-2 border-[#D4A848] py-1 pl-6 text-base font-medium italic leading-relaxed text-[#675F5B] sm:block md:text-lg">
                           The <span className="font-black text-[#362B25]">Highest Priority</span> employment-based visa in the US, architected for individuals with extraordinary global acclaim.
                        </p>

                        <p className="border-l-2 border-[#D4A848] py-1 pl-4 text-sm font-medium italic leading-relaxed text-[#675F5B] sm:hidden">
                           The <span className="font-black text-[#362B25]">Highest Priority</span> US visa for extraordinary global talent.
                        </p>
                     </motion.div>
                  ...
                  {/* RIGHT — image + access card, same top edge as left column */}

        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            ...
            <div className="space-y-4 pt-2">
              <p className="text-[9px] font-black uppercase tracking-[0.3em] text-gold-500/40 italic">Includes Core Nodes:</p>
              <div className="flex flex-wrap gap-8">
                {[
                  { icon: <Video size={16} fill="currentColor" strokeWidth={0} />, color: "#EA4335", label: "Video Call" },
                  { icon: <Phone size={16} fill="currentColor" strokeWidth={0} />, color: "#4285F4", label: "Audio Call" },
                  { icon: (
                    <svg viewBox="0 0 448 512" fill="currentColor" className="w-[14px] h-[14px]">
                  ...
                  ), color: "#25D366", label: "Text Support" }
                ].map((item, i) => (
                  <div key={i} className="flex flex-col items-center gap-2 group">
                     <div className="w-10 h-10 rounded-full bg-white/[0.03] border border-white/10 flex items-center justify-center group-hover:border-gold-500/50 transition-all shadow-sm" style={{ color: item.color }}>
                        {item.icon}
                     </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 pt-4 items-center">
              <Link href="/contact?service=eb1" className="btn-gold px-8 py-3 text-[10px] tracking-widest w-full sm:w-auto text-center !rounded-xl">
                Discuss Your Case
              </Link>
              <Link href="/checkout?service=eb1" className="text-white/40 text-[10px] font-black uppercase tracking-widest hover:text-gold-500 transition-colors border-b border-transparent hover:border-gold-500/20 pb-1">

...
export default function EB1Page() {
  ...
  return (
    <main className="min-h-screen bg-[#F8F6F1] text-[#362B25] font-base selection:bg-[#D4A848]/20 relative overflow-hidden">
      ...
      {/* ── HERO SECTION ── */}
      <section className="relative pt-12 pb-20 px-8 md:px-20 z-10 border-b border-[#D4A848]/10">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            <motion.div variants={itemVariants} className="space-y-3">
              <span className="text-[#D4A848] uppercase tracking-[0.5em] font-black text-[9px] bg-[#FFFFFF] px-4 py-1.5 rounded-full border border-[#D4A848]/20 inline-block shadow-sm">
                Extraordinary Protocol
              </span>
              <h1 className="text-3xl text-[#362B25] md:text-5xl font-black leading-[1.1] uppercase italic tracking-tight">
                APPLY FOR AN <br />
              ...
              <p className="text-base md:text-lg text-[#675F5B] leading-relaxed font-medium italic border-l-2 border-[#D4A848] pl-6">
                The <span className="text-[#362B25] font-black">Highest Priority</span> employment-based visa in the US, architected for individuals with extraordinary global acclaim.
                  ...
                  <div className="pt-2 pl-2">
                     <Link href="/checkout?service=eb1" className="text-[#675F5B] text-[10px] font-black uppercase tracking-[0.3em] hover:text-[#D4A848] transition-colors border-b border-transparent hover:border-[#D4A848]/50 pb-1 italic">
          ...
          >
            <div className="relative aspect-[4/3] w-full group">
               <div className="absolute inset-0 bg-[#D4A848]/15 blur-[100px] rounded-full pointer-events-none group-hover:bg-[#D4A848]/30 transition-all duration-1000" />
               <div className="relative w-full h-full rounded-[3rem] overflow-hidden border border-[#D4A848]/20 group-hover:border-[#D4A848]/50 transition-all duration-1000 shadow-2xl">
                 <Image 
                   src="/eb1-hero.png" 
                 ...
                 />
                 <div className="absolute inset-0 bg-gradient-to-t from-[#362B25]/60 to-transparent" />
               </div>
            </div>
          </motion.div>
        </div>

      ...
      content={
        <div className="space-y-12">
          <section className="space-y-8">
            ...
            <div className="prose prose-invert prose-lg">
              ...
              <p className="text-white/40 leading-relaxed font-medium pt-4 italic">
                At Dr. Alam Global, we help you build a profile that makes you the most desirable candidate. Here is our curated list of the top scholarships.
              </p>
            </div>
          </section>
          ...
          <section className="space-y-8 pt-12 border-t border-white/5">
             <h2 className="text-2xl font-black uppercase tracking-tight italic gradient-text-gold">The Dr. Alam Winning Strategy</h2>

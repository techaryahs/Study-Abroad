  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <motion.div 
        ...
        className="relative w-full max-w-[750px] bg-white rounded-xl overflow-hidden shadow-2xl flex flex-col md:flex-row min-h-[520px] font-sans border border-gray-100"
      >
        {/* LEFT PANEL */}
        ...
        <div className="flex-1 p-8 bg-white flex flex-col">
          ...
          <div className="flex-1 relative">
            <AnimatePresence mode="wait">
              ...
              {step === 4 && (
                <motion.div key="step4" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex flex-col items-center justify-center h-full space-y-6 py-6 font-sans">

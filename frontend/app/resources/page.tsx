  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="inline-block px-5 py-1.5 rounded-full border border-[rgba(197,160,89,0.3)] text-[#C5A059] font-bold text-[10px] tracking-[0.3em] uppercase shadow-sm">
              ...
              >
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex flex-col items-end gap-1">
                    <span className="text-[9px] font-bold text-[#C5A059] border border-[rgba(197,160,89,0.25)] px-2.5 py-0.5 rounded-md uppercase tracking-widest">
                      {category.badge}
                    </span>
                    <span className="text-[10px] font-bold text-[#A8A29E] uppercase tracking-wide">
                      {category.stat}
                    </span>
                  </div>
                </div>
                ...
                {/* CTA */}
                <div className="mt-auto pt-3 flex items-center text-[#C5A059] font-bold text-[10px] tracking-widest uppercase gap-2">

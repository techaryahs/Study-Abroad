...
class _ConsultantDashboardScreenState extends State<ConsultantDashboardScreen> {
  ...
  Future<void> _fetchBookings() async {
    try {
      ...
      setState(() { _bookings = res.data is List ? res.data : []; _loading = false; });
    } catch (_) {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  // Stats
                  Row(children: [
                    _statCard('${_bookings.length}', 'Total Bookings', Icons.calendar_today_rounded),
                    const SizedBox(width: 12),
                    _statCard('${_bookings.where((b) => b['status'] == 'confirmed').length}', 'Confirmed', Icons.check_circle_rounded),
                  ...
                  if (_loading)
                    ...
                    Container(
                      ...
                      child: const Center(
                        child: Text('No bookings yet', style: TextStyle(color: AppTheme.textSecondary, fontSize: 13)),
                      ),
                    )
                  else
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(b['studentName'] ?? b['name'] ?? 'Student',
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Text(label, style: const TextStyle(fontSize: 9, color: AppTheme.textSecondary, fontWeight: FontWeight.w700)),
              ],
            ),
          ],
        ),

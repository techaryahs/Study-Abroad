...
class _MockInterviewScreenState extends State<MockInterviewScreen> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Master Your',
            style: TextStyle(fontSize: 36, fontWeight: FontWeight.w700, fontFamily: 'Playfair Display', height: 1.1, color: Color(0xFF2D2926)),
          ...
          ShaderMask(
            ...
            child: const Text(
              'Visa Interview',
              style: TextStyle(fontSize: 36, fontWeight: FontWeight.w700, fontFamily: 'Playfair Display', color: Colors.white, height: 1.1),
            ),
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: const Text('VO', style: TextStyle(color: Color(0xFF2D2926), fontWeight: FontWeight.w900, fontSize: 8)),
                      ),
                  ...
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: Container(
                          ...
                          child: const Text(
                            ...
                            style: TextStyle(color: Color(0xFF2D2926), fontSize: 11, height: 1.5, fontWeight: FontWeight.w600),
                          ),
                        ),
                      ),
                      const SizedBox(width: 10),
                      Container(
                        ...
                        alignment: Alignment.center,
                        child: const Text('YOU', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 8)),
                      ),
                    ],
                  ),
  ...
  Widget _buildCapabilitiesSection() {
    final items = [
      {'icon': Icons.videocam_rounded, 'title': 'Video Simulation', 'desc': 'Face an AI-driven officer with real-time facial analysis and stress level monitoring.'},
      {'icon': Icons.bolt_rounded, 'title': 'Instant Diagnostics', 'desc': 'Get immediate scoring on your confidence, grammar, and factual consistency.'},
      {'icon': Icons.verified_user_rounded, 'title': 'Approval Predictor', 'desc': 'Our neural network predicts your approval percentage based on historical visa trends.'},
    ];
    ...
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Core Capabilities', style: TextStyle(fontSize: 26, fontWeight: FontWeight.w700, fontFamily: 'Playfair Display', color: Color(0xFF2D2926))),
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Icon(item['icon'] as IconData, color: const Color(0xFFC5A059), size: 22),
                  ),
            ...
            children: stats.map((stat) => Column(
              ...
              children: [
                ShaderMask(
                  ...
                  child: Text(
                    stat['val']!,
                    style: const TextStyle(fontSize: 32, fontWeight: FontWeight.w900, fontFamily: 'Playfair Display', color: Colors.white),
                  ),
                ),
                const SizedBox(height: 4),
                Text(
      ...
      child: Column(
        children: [
          ...
          RichText(
            ...
            text: const TextSpan(
              children: [
                TextSpan(text: 'Elite ', style: TextStyle(fontSize: 30, fontWeight: FontWeight.w700, fontFamily: 'Playfair Display', color: Color(0xFF2D2926))),
                TextSpan(text: 'Access Protocols', style: TextStyle(fontSize: 30, fontWeight: FontWeight.w700, fontFamily: 'Playfair Display', color: Color(0xFFC5A059))),
              ],
            ),
          ),
          const SizedBox(height: 12),
          const Text(
            ...
            textAlign: TextAlign.center,
            style: TextStyle(color: Color(0xFF6B5E51), fontSize: 13, fontStyle: FontStyle.italic, height: 1.6),
          ),
          const SizedBox(height: 24),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: ['USD', 'INR', 'GBP', 'EUR'].map((c) => GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: selectedCurrency == c ? const Color(0xFF2D2926) : Colors.transparent,
                  borderRadius: BorderRadius.circular(100),
                  border: Border.all(
                    color: selectedCurrency == c ? const Color(0xFF2D2926) : const Color(0xFFE8E2DD),
                  ),
                ),
                child: Text(
                  c,
          ...
          ...plans.map((plan) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: isHighlight ? const Color(0xFF2D2926) : const Color(0x26C5A059)),
                boxShadow: isHighlight ? [BoxShadow(color: Colors.black.withOpacity(0.2), blurRadius: 30, offset: const Offset(0, 15))] : [],
              ),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          color: isHighlight ? Colors.white : const Color(0xFF2D2926),
                        ),
                      ),
                      if (plan['label'] != null)
                        Container(
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                          color: isHighlight ? Colors.white38 : const Color(0xFF6B5E51),
                          fontSize: 13,
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          color: isHighlight ? const Color(0xFFC5A059) : const Color(0xFF2D2926),
                        ),
                      ),
                    ],
                  ),
                  ...
                  ...(plan['features'] as List<String>).map((f) => Padding(
                    ...
                    child: Row(
                      children: [
                        const Icon(Icons.check_circle_rounded, color: Color(0xFFC5A059), size: 16),
                        const SizedBox(width: 10),
                        Text(
                          f,
                          style: TextStyle(
                            ...
                            color: isHighlight ? Colors.white60 : const Color(0xFF6B5E51),
                          ),
                        ),
                      ],
                    ),
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Our advisors are ready to guide your interview prep. We will contact you shortly.'),
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        foregroundColor: isHighlight ? const Color(0xFF2D2926) : Colors.white,
                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
                        elevation: 0,
                      ),
                      child: const Text('CONSULT INTERVIEW EXPERT', style: TextStyle(fontWeight: FontWeight.w900, letterSpacing: 1.5, fontSize: 11)),
                    ),
                  ),
                ],
              ),
      ...
      child: Column(
        children: [
          RichText(
            ...
            text: const TextSpan(
              children: [
                TextSpan(text: 'Protocol ', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w700, fontFamily: 'Playfair Display', color: Color(0xFF2D2926))),
                TextSpan(text: 'Inquiries', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w700, fontFamily: 'Playfair Display', color: Color(0xFFC5A059))),
              ],
            ),
          ),
          const SizedBox(height: 8),
          const Text(
            ...
            textAlign: TextAlign.center,
            style: TextStyle(color: Color(0xFF6B5E51), fontSize: 13, fontStyle: FontStyle.italic),
          ),
          const SizedBox(height: 32),
                      ...
                      child: Row(
                        children: [
                          Expanded(
                            child: Text(
                              ...
                              style: TextStyle(
                                fontSize: 13,
                                fontWeight: FontWeight.w700,
                                color: isOpen ? const Color(0xFFC5A059) : const Color(0xFF2D2926),
                                letterSpacing: 0.2,
                                height: 1.4,
                              ),
                            ),
                          ...
                          AnimatedRotation(
                            ...
                            child: const Icon(Icons.keyboard_arrow_down_rounded, color: Color(0xFFC5A059)),
                          ),
                        ],
                      ),
                    ),

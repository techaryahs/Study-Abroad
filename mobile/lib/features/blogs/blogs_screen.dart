            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: const Text('✦ FEATURED', style: TextStyle(color: AppTheme.gold, fontSize: 9, fontWeight: FontWeight.w800, letterSpacing: 2)),
                ),
                ...
                const Spacer(),
                Row(children: [
                  Text('Apr 10, 2026', style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 11)),
                  const Spacer(),
                  const Text('8 min read', style: TextStyle(color: AppTheme.gold, fontSize: 11, fontWeight: FontWeight.w700)),
                ]),
              ],
            ),
                      ...
                      children: [
                        Container(
                          ...
                          child: Text(b['category']!,
                              style: const TextStyle(fontSize: 9, fontWeight: FontWeight.w800, color: AppTheme.gold, letterSpacing: 0.5)),
                        ),
                        ...
                        const SizedBox(height: 6),
                        Row(children: [
                          Text(b['date']!, style: const TextStyle(fontSize: 10, color: AppTheme.textSecondary)),
                          const Text(' · ', style: TextStyle(color: AppTheme.textSecondary)),
                          Text(b['readTime']!, style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: AppTheme.gold)),
                        ]),
                      ],
                    ),
                  ),
